...
BOOST_AUTO_TEST_CASE(python_simple_script_test) {
  ...
  boost::leaf::try_handle_all(
      []() -> boost::leaf::result<void> {
        ...
        BOOST_LEAF_CHECK(
            py.run("print ('Hello Wolf from Python')", _requested_vars));
        return {};
      },
...
BOOST_AUTO_TEST_CASE(python_get_variable_from_script_test) {
  ...
  boost::leaf::try_handle_all(
      []() -> boost::leaf::result<void> {
        auto py = w_python(PYTHON_HOME);
        auto _requested_vars =
            std::unordered_map<std::string, std::any>{{"x", (int)0}};
...
//     python_wrapper::run_simple_script_from_file("D:/script.py"); // using
//     global function std::cout << "Done\n";
// }
...
//     python_wrapper::PythonRunner pr; // using object
//     auto val =
//     pr.run_function_from_script_file_and_get_result<int>("D:/simple_math.py",
//     "return_42"); std::cout << val << '\n';
//    // python_wrapper::run_simple_script_from_file("D:/script.py"); // using
//    global function
//     std::cout << "Done\n";
// }
