...
//   const wolf::system::w_leak_detector _detector = {};
//
//   std::cout << "entering test case 'lua_run_from_buffer_bad_script_test'" <<
//   std::endl; boost::leaf::try_handle_all(
//       []() -> boost::leaf::result<void> {
//         w_lua lua;
//         lua.open_libraries(w_lib::base);
//
...
//       [] {
//         std::cout << "lua_run_from_buffer_bad_script_test expected error from
//         bad luad script" << std::endl; BOOST_CHECK(true);
//       });
//
//   std::cout << "leaving test case 'lua_run_from_buffer_bad_script_test'" <<
//   std::endl;
// }
//
...
//   const wolf::system::w_leak_detector _detector = {};
//
//   std::cout << "entering test case 'lua_run_from_buffer_return_value_test'"
//   << std::endl;
//
//   boost::leaf::try_handle_all(
//       []() -> boost::leaf::result<void> {
...
//         lua.open_libraries(w_lib::base);
//
//         auto result = lua.run_from_buffer<int, std::string>("return 1234,
//         'lua'"); if (!result) {
//           return result.error();
//         }
//
...
//       });
//
//   std::cout << "leaving test case 'lua_run_from_buffer_return_value_test'" <<
//   std::endl;
// }
//
...
//   const wolf::system::w_leak_detector _detector = {};
//
//   std::cout << "entering test case 'lua_call_function_one_return_value_test'"
//   << std::endl;
//
//   boost::leaf::try_handle_all(
//       []() -> boost::leaf::result<void> {
...
//         lua.open_libraries(w_lib::base);
//
//         BOOST_LEAF_CHECK(lua.run_from_buffer("function f (a, b, c, d) return
//         a + b + c + d end")); BOOST_LEAF_AUTO(result,
//         lua.call_function<int>("f", 1, 2, 3, 4)); auto value =
//         std::get<0>(result);
//
...
//         + p_trace.to_string());
//       },
//       [] { BOOST_ERROR("lua_call_function_one_return_value_test got an
//       error"); });
//
//   std::cout << "leaving test case 'lua_call_function_one_return_value_test'"
//   << std::endl;
// }
//
...
//   const wolf::system::w_leak_detector _detector = {};
//
//   std::cout << "entering test case 'lua_call_function_two_return_value_test'"
//   << std::endl;
//
//   boost::leaf::try_handle_all(
//       []() -> boost::leaf::result<void> {
...
//
//         BOOST_LEAF_CHECK(lua.run_from_buffer("function f (a, b, c, d) return
//         a, b end")); auto f = lua.call_function<int, int>("f", 1, 2, 3, 4);
//         if (!f) {
//           return f.error();
//         }
...
//         + p_trace.to_string());
//       },
//       [] { BOOST_ERROR("lua_call_function_two_return_value_test got an
//       error"); });
//
//   std::cout << "leaving test case 'lua_call_function_two_return_value_test'"
//   << std::endl;
// }
//
...
//   const wolf::system::w_leak_detector _detector = {};
//
//   std::cout << "entering test case 'lua_call_function_nonexistent_test'" <<
//   std::endl;
//
//   boost::leaf::try_handle_all(
//       []() -> boost::leaf::result<void> {
...
//       [] {
//         std::cout
//             << "lua_call_function_nonexistent_test called non-existent
//             function which returns error"
//             << std::endl;
//         BOOST_CHECK(true);
//       });
//
//   std::cout << "leaving test case 'lua_call_function_nonexistent_test'" <<
//   std::endl;
// }
//
...
//   const wolf::system::w_leak_detector _detector = {};
//
//   std::cout << "entering test case 'lua_call_function_unmatched_types_test'"
//   << std::endl;
//
//   boost::leaf::try_handle_all(
//       []() -> boost::leaf::result<void> {
...
//         lua.open_libraries(w_lib::base);
//
//         BOOST_LEAF_CHECK(lua.run_from_buffer("function f () return 'hello
//         world' end")); BOOST_LEAF_AUTO(result, lua.call_function<int>("f"));
//
//         return {};
//       },
//       [](const w_trace &p_trace) { BOOST_CHECK(true); },
//       [] {
//         std::cout
//             << "lua_call_function_unmatched_types_test with mismatched return
//             types must return error"
//             << std::endl;
//         BOOST_CHECK(true);
//       });
//
//   std::cout << "leaving test case 'lua_call_function_unmatched_types_test'"
//   << std::endl;
// }
//
...
//   const wolf::system::w_leak_detector _detector = {};
//
//   std::cout << "entering test case 'lua_bind_to_function_lambda_test'" <<
//   std::endl;
//
//   boost::leaf::try_handle_all(
//       []() -> boost::leaf::result<void> {
...
//       [] { BOOST_ERROR("lua_bind_to_function_lambda_test got an error"); });
//
//   std::cout << "leaving test case 'lua_bind_to_function_lambda_test'" <<
//   std::endl;
// }
//
// int free_function() {
...
//         lua.open_libraries(w_lib::base);
//
//         BOOST_LEAF_CHECK(lua.bind_to_function("cpp_function",
//         free_function)); BOOST_LEAF_AUTO(result,
//         lua.call_function<int>("cpp_function")); auto value =
//         std::get<0>(result);
//
//         BOOST_REQUIRE(value == 1234);
//         return {};
//       },
//       [](const w_trace &p_trace) { BOOST_ERROR("lua_test got an error: " +
//       p_trace.to_string()); },
...
//           BOOST_LEAF_CHECK(
//               lua.bind_to_function("cpp_function",
//               &bind_member_function::member, var));
//
//           BOOST_LEAF_AUTO(result, lua.call_function<int>("cpp_function"));
//           auto value = std::get<0>(result);
//
...
//
//           BOOST_ERROR("running scripts without loading one must return
//           error"); return {};
//         },
//         [](const w_trace &p_trace) { BOOST_CHECK(true); }, [] {
//         BOOST_CHECK(true); });
...
//           lua.open_libraries(w_lib::base);
//
//           BOOST_LEAF_CHECK(lua.load_from_buffer("local a,b = ... return
//           a,b"));
//
...
//           lua.open_libraries(w_lib::base);
//
//           BOOST_LEAF_CHECK(lua.set_global_variable("string_var", "hello
//           world")); BOOST_LEAF_CHECK(lua.set_global_variable("int_var",
//           1234));
//
//           std::string string_var;
//           int int_var;
//
//           BOOST_LEAF_CHECK(lua.get_global_variable("string_var",
//           string_var)); BOOST_REQUIRE(string_var == "hello world");
//
