...
boost::asio::awaitable<size_t> w_ws_client::async_write(
    _In_ const w_buffer &p_buffer, _In_ bool p_is_binary) {
  if (p_is_binary) {
...
boost::asio::awaitable<size_t> w_ws_client::async_read(
...
boost::asio::awaitable<size_t> w_ws_client::async_read(
    _Inout_ boost::beast::flat_buffer &p_mut_buffer) {
