...
//   SDL_Event sdl_event = {};
//   w_gamepad_client_button button{.type =
//   w_gamepad_client_event_type::button}; w_gamepad_client_axis axis{.type =
//   w_gamepad_client_event_type::axis}; w_gamepad_client_event _event = {};
...
//       button.button =
//           gsl::narrow_cast<w_gamepad_client_button_type>(sdl_event.cbutton.button
//           + 1);
//       button.state = sdl_event.cbutton.state ?
//       w_gamepad_client_state_type::pressed
//                                              :
...
//       axis.axis =
//           gsl::narrow_cast<w_gamepad_client_axis_type>(sdl_event.caxis.axis +
//           1);
...
//       auto controller =
//       SDL_GetGamepadFromInstanceID(sdl_event.cdevice.which); auto _iter =
//           std::find(s_controllers.cbegin(), s_controllers.cend(),
//           controller);
