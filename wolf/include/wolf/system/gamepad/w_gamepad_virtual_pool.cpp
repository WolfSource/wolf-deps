...
std::string w_gamepad_virtual_pool::vigem_error_to_string(
  ...
  switch (p_error) {
    ...
    case VIGEM_ERROR::VIGEM_ERROR_ALREADY_CONNECTED:
      return "VIGEM_ERROR_ALREADY_CONNECTED: an attempt has been made to plug "
             "in "
    ...
    case VIGEM_ERROR::VIGEM_ERROR_BUS_ALREADY_CONNECTED:
      return "VIGEM_ERROR_BUS_ALREADY_CONNECTED: bus driver found but failed "
             "to "
             "open a handle.";
    ...
    case VIGEM_ERROR::VIGEM_ERROR_INVALID_PARAMETER:
      return "VIGEM_ERROR_INVALID_PARAMETER: bus driver found but failed to "
             "open "
             "a handle.";
    case VIGEM_ERROR::VIGEM_ERROR_NOT_SUPPORTED:
      return "VIGEM_ERROR_NOT_SUPPORTED: the API is not supported by the "
             "driver";
